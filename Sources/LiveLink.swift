...
final class LiveLink: ObservableObject {
    ...
    func statusJSON() -> String {
        ...
        return "{\"ok\":true,\"battery\":\(pct),\"approx\":true,\"charging\":\(charging),\"full\":\(full),\"lowPower\":\(lowPower)" + HealthBridge.shared.statusFragment() + LockBridge.shared.statusFragment() + ",\"ts\":\(ts),\"app\":\"YuyuanBridge\"}"
    }
